    ...
    <div className="flex bg-[#f1f5f9] min-h-screen">
      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Today's Deposit Collections</h1>
            <p className="text-gray-500 font-medium">Tracking all installment payments received today</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <div className="p-20 text-center text-gray-400 italic">No deposit payments have been recorded yet today.</div>
            ) : (

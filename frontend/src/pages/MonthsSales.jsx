    ...
    <div className="flex bg-[#f1f5f9] min-h-screen">
      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Monthly Sales</h1>
            <p className="text-gray-500 font-medium">Performance tracking for the current month</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-gray-50 px-8 py-4 border-b border-gray-100 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <div className="text-[10px] text-gray-400 font-black uppercase tracking-widest">Total Volume</div>
                <div className="text-lg font-black text-gray-900">{formatCurrency(sales.reduce((acc, s) => acc + s.total_amount, 0))}</div>
              </div>
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <div className="p-20 text-center text-gray-400 italic">No sales recorded for this month yet.</div>
            ) : (
                  ...
                  {sales.map((sale) => (
                    <tr key={sale.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-8 py-4 text-center text-gray-500 font-medium">
                        ...
                        <div className="text-[10px] uppercase font-black text-gray-400">{new Date(sale.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</div>
                      </td>
                      <td className="px-8 py-4 text-center">
                        {sale.receipt_uuid && (
                          <a
                            ...
                            className="bg-purple-50 text-purple-600 p-2 rounded-lg hover:bg-purple-600 hover:text-white transition-all inline-flex items-center gap-1 font-bold text-xs"
                          >

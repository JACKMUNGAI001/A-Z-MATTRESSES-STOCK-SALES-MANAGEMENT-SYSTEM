        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <div className="p-20 text-center text-gray-400 dark:text-gray-500 italic font-medium transition-colors">No active deposit customers found.</div>
            ) : (
                  ...
                  {customers.map((customer) => (
                    <tr key={customer.id} className="hover:bg-indigo-50/10 dark:hover:bg-indigo-900/10 transition-colors">
                      <td className="px-8 py-4">
                        <div className="font-black text-gray-900 dark:text-white transition-colors">{customer.buyer_name}</div>
                      ...
                      <td className="px-8 py-4">
                        <div className="flex items-center gap-2 font-bold text-gray-700 dark:text-gray-300 transition-colors">
